...
export const ROUTES = {
  ...
  PODS: '/k8s/workloads/pods',
  DEPLOYMENTS: '/k8s/workloads/deployments',
  SERVICES: '/k8s/network/services',
  INGRESS: '/k8s/network/ingress',
  CONFIG_MAPS: '/k8s/config/configmaps',
  SECRETS: '/k8s/config/secrets',
  PERSISTENT_VOLUMES: '/k8s/storage/persistent-volumes',
  PERSISTENT_VOLUME_CLAIMS: '/k8s/storage/persistent-volume-claims',
  STORAGE_CLASSES: '/k8s/storage/storage-classes',
  SERVICE_ACCOUNTS: '/k8s/rbac/service-accounts',
  ROLES: '/k8s/rbac/roles',
  ROLE_BINDINGS: '/k8s/rbac/role-bindings',
  CLUSTER_ROLES: '/k8s/rbac/cluster-roles',
  CLUSTER_ROLE_BINDINGS: '/k8s/rbac/cluster-role-bindings',
  RESOURCE_QUOTAS: '/k8s/quota/resource-quotas',
  LIMIT_RANGES: '/k8s/quota/limit-ranges',
  CLUSTERS: '/k8s/cluster/clusters',
  NODES: '/k8s/cluster/nodes',
  NAMESPACES: '/k8s/cluster/namespaces',
  EVENTS: '/k8s/cluster/events',
} as const;
