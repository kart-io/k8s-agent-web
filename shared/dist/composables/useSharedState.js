 ...
 */
function useSharedState(namespace, key, defaultValue) {
 ...
 * ])
 */
function useMultipleSharedStates(states) {
  const result = {};
...
export { useSharedState as default, useMultipleSharedStates, useSharedState };
